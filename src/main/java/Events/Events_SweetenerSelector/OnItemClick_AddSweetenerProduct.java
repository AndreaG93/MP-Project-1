 ...
 * @version 1.0
 */
public class OnItemClick_AddSweetenerProduct implements AdapterView.OnItemClickListener
{
     ...
     */
    public OnItemClick_AddSweetenerProduct(Context arg0, ListView arg1)
    {
        this.context = arg0;
        this.list = arg1;
    }
    ...
    {
        SelectedProduct.getInstance().set_SweetenerProduct((Product) list.getItemAtPosition(i));
